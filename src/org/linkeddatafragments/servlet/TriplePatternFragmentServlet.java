...
import org.linkeddatafragments.datasource.HdtPPDataSource;
...
//}
        ...
        try
        {
            ...
            if(request.getParameter("triples") == null) {
                ...
                int num = Integer.parseInt(request.getParameter("triples"));
                ...
                if (bindings != null) {
                    _fragment = ((HdtPPDataSource)dataSource).getBindingFragment(star, offset,
                            limit, bindings, foundVariables);
                } else {
                    _fragment = ((HdtPPDataSource)dataSource).getFragment(star, offset, limit);
                }
            }
